...
@section('content')
    ...
    <div id="container-prices" class="container">
                                    ...
                                    <div class="body-area">
                                        <ul class="plan-list">
                                            ...
                                            @else
                                                <li>
                                                    <stron class="old-val">
                                                        ${{$plan->month * $plans->first()->cost}}</stron>
                                        ...
                                        @if($plan->month === 12)
                                            <div class="image-holder"><img src="{{asset('images/best-deal.png')}}"
                                                                           alt="be">
                                            </div>
                                        @endif
                                        <a href="{{route('step-one', ['plan' => $plan->slug])}}" class="btn">get
                                            started</a>
                                    </div>
                                </div>
                            @endforeach
