<template>
  <div class="col-lg-12 col-sm-12" id="box-meal-profile" style="margin-top: 30px;">
    <div class="col-lg-6 col-sm-6">
      ...
      <button @click="regenerateMeals" class="btn btn-default" id="btn-meal-shuffle"><i class="fa fa-random"></i>
      </button>
      <span style="margin-top: 5px"><i class="fa fa-question circle" data-toggle="tooltip"
                                       title="You can regenerate the meals by clicking the button!"></i></span>
    </div>
    <div class="col-lg-6 col-sm-6">
        ...
        <div class="panel panel-default">
          <table class="table table-hover">
            ...
            <meal-item
                :meal="meal"
                :is-user="isUser"
                v-on:meal-completed="markCompleted($event, meal.id)">
            </meal-item>
            </tbody>
          </table>
        </div>
  ...
  export default {
    ...
    methods: {
      async regenerateMeals() {
        ...
        await (ApiUtil.postToApi(url, formData).then((data) => {
